...
propertyExpectation(latencySilver, infraIntent, latency, lower, silver, 10, ms, begin, end).
propertyExpectation(latencyGold, infraIntent, latency, lower, gold, 2, ms, begin, end).
